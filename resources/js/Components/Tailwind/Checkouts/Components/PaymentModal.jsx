            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="p-6 max-h-[80vh]">
                        ...
                        <div
                            className={`border rounded-lg p-3 cursor-pointer transition-colors ${
                                paymentMethod === "tarjeta"
                                    ? "border-[#3a2723] bg-[#f8f5f2]"
                                    : "border-gray-200 hover:border-[#3a2723]"
                            }`}
                            ...
                            <div className="flex flex-row items-center justify-between">
                                <div className="flex flex-col items-start justify-center space-x-2">
                                    <input
                                        ...
                                        className="h-5 w-5 text-[#3a2723] focus:ring-[#3a2723] hidden"
                                    />
                                    <label
                                        htmlFor="tarjeta"
                                    ...
                                    <p className="text-[#5c504c] ml-7 mt-1">
                    ...
                    <div className="mt-8 space-y-3">
                        <button
                            className={`w-full bg-[#3a2723] hover:bg-[#2a1d1a] text-white py-4 rounded-md text-lg font-medium transition-colors ${
                        ...
                        <button
                            className="w-full border border-[#3a2723] text-[#3a2723] hover:bg-[#f8f5f2] py-4 rounded-md text-lg font-medium transition-colors"
                            onClick={onClose}
                            disabled={saving}
                        >
                            Volver
