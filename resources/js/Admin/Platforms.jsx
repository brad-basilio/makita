...
import PlatformsRest from "../Actions/Admin/PlatformsRest";
...
const Platforms = () => {
    ...
    const onModalSubmit = async (e) => {
        ...
        const result = await platformsRest.save(formData);
        if (!result) return;
    ...
    const onFeaturedChange = async ({ id, value }) => {
        const result = await platformsRest.boolean({
            id,
            field: "featured",
            value,
        });
    ...
    const onDeleteClicked = async (id) => {
        ...
        const result = await platformsRest.delete(id);
        if (!result) return;
        $(gridRef.current).dxDataGrid("instance").refresh();
    };
...
CreateReactScript((el, properties) => {
    createRoot(el).render(
        <BaseAdminto {...properties} title="Plataformas">
