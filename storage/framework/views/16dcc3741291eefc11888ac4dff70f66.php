        ...
        <table style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);" cellpadding="0" cellspacing="0" border="0">
          ...
          <tr>
            <td style="background-color: #1e293b; padding: 24px; text-align: center;">
              <h1 style="color: #ffffff; font-size: 24px; margin: 0;"><?php echo e(config('app.name')); ?></h1>
            </td>
          </tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="text-align: center; padding-bottom: 20px;">
                    <h2 style="font-size: 20px; color: #333333; margin: 0;">¡Hola, <?php echo e($name); ?>!</h2>
                    <p style="margin-top: 10px; color: #666666;">Gracias por tu compra en <?php echo e(config('app.name')); ?></p>
                  </td>
                </tr>
              </table>
                  ...
                  <td style="padding: 16px;">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        ...
                        <td style="text-align: right; font-weight: bold;"><?php echo e($orderId); ?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td style="text-align: right;">
                          ...
                          ?>
                          <span style="display: inline-block; padding: 4px 12px; border-radius: 50px; background-color: <?php echo e($color); ?>; color: white; font-size: 14px; font-weight: 500;"><?php echo e($status); ?></span>
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 24px;">
                ...
                <tr>
                  <td>
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td width="23%" style="height: 4px; background-color: <?php echo e($color1); ?>; border-radius: 4px;"></td>
                        <td width="2%"></td>
                        <td width="23%" style="height: 4px; background-color: <?php echo e($color2); ?>; border-radius: 4px;"></td>
                        <td width="2%"></td>
                        <td width="23%" style="height: 4px; background-color: <?php echo e($color3); ?>; border-radius: 4px;"></td>
                        <td width="2%"></td>
                        <td width="23%" style="height: 4px; background-color: <?php echo e($color4); ?>; border-radius: 4px;"></td>
                      </tr>
                    </table>
                  </td>
                </tr>
          ...
          <tr>
            <td style="background-color: #f9f9f9; padding: 16px; text-align: center; border-top: 1px solid #e5e7eb;">
              ...
              <p style="margin-top: 8px; font-size: 14px; color: #6b7280;"><?php echo e(config('app.name')); ?> © <?php echo e(date('Y')); ?>. Todos los derechos reservados.</p>
            </td>
          </tr>
        </table>
      </td>
...
</html><?php /**PATH C:\xampp\htdocs\projects\stechperu_final\storage\framework\views/f5b068e8a977536144c0e5bd2a776b1a.blade.php ENDPATH**/ ?>